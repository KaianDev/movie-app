...
export const Footer = () => {
  return (
    <footer className="bg-[#212529] py-24">
      <div className="grid grid-col-1 text-center sm:text-start sm:grid-cols-2 md:grid-cols-4 container mx-auto px-4 md:px-10 text-white/80 gap-8 sm:gap-4">
        {/* Contact */}
