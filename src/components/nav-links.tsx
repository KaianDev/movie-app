          ...
          <div className="w-full sm:w-80 bg-[#f8f9fa] flex flex-col justify-between py-6 px-4">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-black mb-4 flex items-center p-1 w-full bg-zinc-100 border">
                ...
                <input
                  type="search"
                  className="p-2 outline-none bg-transparent text-lg flex-1"
                  placeholder="Search"
                />
              </div>
              ...
              <a
                href="#"
                className="text-black font-semibold text-2xl py-6 px-2 border-b w-full text-center hover:bg-zinc-100">
                Home
              </a>
              <a
                href="#"
